...
def main():
    ...
    train_env = qf.MultiAgentPortfolioEnv(tensorboard_prefix="TRAIN") # Note optional config
    eval_env = qf.MultiAgentPortfolioEnv(tensorboard_prefix="EVAL") # Note optional config
    ...
    # Evaluate the agent
    agent.evaluate(eval_env, num_episodes=1, use_tqdm=True)