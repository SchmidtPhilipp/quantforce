...
def getMSCIWorld():
    """
    Downloads the MSCI World data from Wikipedia and manages it.
    """
...
if __name__ == "__main__":
    ...
    msci_world_tickers = getMSCIWorld()
