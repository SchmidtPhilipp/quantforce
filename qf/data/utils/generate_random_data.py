...
def generate_random_data(
    ...
    Parameters:
        ...
        interval (str): Frequency of data ('1d', '1wk', '1mo', '1h', etc.). Default is '1d'.
        tickers (list[str]): List of ticker symbols to include in the MultiIndex. Default is ['AAPL', 'MSFT'].

    Returns:
        pd.DataFrame: Randomly generated financial data with a MultiIndex (Ticker, Price) and columns
    ...
    # Support more intervals
    supported_intervals = ["1d", "1wk", "1mo", "1h", "30m", "15m", "5m", "1m"]
    ...
    # Set column names to the MultiIndex - now (Ticker, Price) format
