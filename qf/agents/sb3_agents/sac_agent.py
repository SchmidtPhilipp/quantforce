...
class SACAgent(SB3Agent):
    def __init__(self, env, config=None):
        ...
        self.model.train = lambda gradient_steps, batch_size=64: train_SAC_with_TD_error_logging(self.model, gradient_steps, batch_size)
...
def train_SAC_with_TD_error_logging(self, gradient_steps: int, batch_size: int = 64) -> None:
    ...
    self.env.envs[0].env.env.logger.record("TRAIN_model_loss/ent_coef", np.mean(ent_coefs))
