...
from qf import DEFAULT_CONSOLE_LEVELS, DEFAULT_LOG_DIR, DEFAULT_LOG_LEVELS, VERBOSITY
...
def setup_logging(
    ...
    console_levels: Optional[
        List[str]
    ] = DEFAULT_CONSOLE_LEVELS,  # Will be set based on verbosity if None
    ...
    if not console_only:
        ...
        for level in log_levels:
            ...
            path = Path(log_dir) / f"{timestamp}_{level_lower}.log"
        ...
        all_log_path = Path(log_dir) / f"{timestamp}_all.log"
